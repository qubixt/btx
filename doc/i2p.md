...
debug log about your I2P configuration and connections. Run `btx-cli help
...
`btx-cli -addrinfo` to see the number of I2P addresses known to your node.
...
To see which I2P peers your node is connected to, use `btx-cli -netinfo 4`
or the `getpeerinfo` RPC (e.g. `btx-cli getpeerinfo`).

You can use the `getnodeaddresses` RPC to fetch a number of I2P peers known to your node; run `btx-cli help getnodeaddresses` for details.
