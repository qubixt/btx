...
function(add_maintenance_targets)
  ...
  foreach(target IN ITEMS bitcoind bitcoin-qt bitcoin-cli bitcoin-tx bitcoin-util bitcoin-wallet test_btx bench_bitcoin)
    if(TARGET ${target})
...
function(add_windows_deploy_target)
  if(MINGW AND TARGET bitcoin-qt AND TARGET bitcoind AND TARGET bitcoin-cli AND TARGET bitcoin-tx AND TARGET bitcoin-wallet AND TARGET bitcoin-util AND TARGET test_btx)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:test_btx> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:test_btx>
