        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    // NOTE: figure out the right way to synchronize around mocktime, and
...
static RPCHelpMan getgeneralinfo()
{
    return RPCHelpMan{"getgeneralinfo",
                "Returns data about the BTX daemon.\n",
                {},
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static RPCHelpMan echo(const std::string& name)
{
    return RPCHelpMan{name,
                ...
                "btx-cli and the GUI. There is no server-side difference.",
        {
