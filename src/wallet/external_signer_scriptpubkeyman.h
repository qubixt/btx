...
{
  private:
  bool PopulateDerivedCache(uint32_t index, DescriptorCache& cache, std::string& error) const override;
  ...
  */
  ...
  static util::Result<ExternalSigner> GetExternalSigner2(std::optional<std::string> signer_fingerprint = std::nullopt);
