...
// TO-DO clarify address expectations, and make them more uniform.
// TO-DO i.e. do we expect types to be set already?
// TO-DO and do we expect modifications or copies?
