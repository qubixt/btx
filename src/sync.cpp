...
// On release-style builds this translation unit can otherwise compile down to
// an empty object, which triggers noisy ranlib warnings on arm64 archives.
void btx_sync_build_anchor() {}
#endif
