...
BOOST_AUTO_TEST_CASE(timeoffsets_min_int64_no_overflow)
{
    node::Warnings warnings{};
    TimeOffsets offsets{warnings};
    const auto min_sec = std::chrono::seconds{std::numeric_limits<int64_t>::min()};

    AddMulti(offsets, {min_sec, min_sec, min_sec, min_sec, min_sec});
