...
BOOST_AUTO_TEST_CASE(islikelycrossnetworkport)
{
    constexpr uint16_t BTX_MAINNET_PORT{19335};

    BOOST_CHECK(IsLikelyCrossNetworkPort(8333, BTX_MAINNET_PORT));
    BOOST_CHECK(IsLikelyCrossNetworkPort(18333, BTX_MAINNET_PORT));
    BOOST_CHECK(IsLikelyCrossNetworkPort(38333, BTX_MAINNET_PORT));
    BOOST_CHECK(IsLikelyCrossNetworkPort(48333, BTX_MAINNET_PORT));

    BOOST_CHECK(!IsLikelyCrossNetworkPort(BTX_MAINNET_PORT, BTX_MAINNET_PORT));
    BOOST_CHECK(!IsLikelyCrossNetworkPort(19336, BTX_MAINNET_PORT));
    BOOST_CHECK(!IsLikelyCrossNetworkPort(8333, 8333));
}
