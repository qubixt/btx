...
CTxDestination ConsumeTxDestination(FuzzedDataProvider& fuzzed_data_provider) noexcept
{
    ...
    const size_t call_size{CallOneOf(
        ...
        [&] {
            ...
            // Witness v2 is reserved for P2MR and only valid with a 32-byte program.
            // Keep fuzzed "unknown" witnesses in v3..v16 so encode/decode semantics stay consistent.
