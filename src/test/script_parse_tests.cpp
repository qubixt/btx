...
BOOST_AUTO_TEST_CASE(parse_script)
{
    ...
    BOOST_CHECK_EQUAL(HexStr(ParseScript("OP_CHECKTEMPLATEVERIFY")), "b3");
    BOOST_CHECK_EQUAL(HexStr(ParseScript("OP_NOP4")), "b3");
    BOOST_CHECK_EQUAL(HexStr(ParseScript("OP_CHECKSIG_MLDSA")), "bb");
    BOOST_CHECK_EQUAL(HexStr(ParseScript("OP_CHECKSIG_SLHDSA")), "bc");
    BOOST_CHECK_EQUAL(HexStr(ParseScript("OP_CHECKSIGFROMSTACK")), "bd");
}
