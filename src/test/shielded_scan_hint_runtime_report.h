...
#ifndef BTX_TEST_SHIELDED_SCAN_HINT_RUNTIME_REPORT_H
#define BTX_TEST_SHIELDED_SCAN_HINT_RUNTIME_REPORT_H
...
#endif // BTX_TEST_SHIELDED_SCAN_HINT_RUNTIME_REPORT_H
