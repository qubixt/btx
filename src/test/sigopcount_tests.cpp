...
BOOST_AUTO_TEST_CASE(GetTxSigOpCost)
{
    ...
    // P2MR witness program (weighted PQ sigop counting)
    {
        ...
        scriptPubKey << OP_2 << ToByteVector(merkle_root);
        CScriptWitness scriptWitness;
        scriptWitness.stack.emplace_back();
        scriptWitness.stack.emplace_back();
        scriptWitness.stack.emplace_back();
        scriptWitness.stack.emplace_back(leaf_script.begin(), leaf_script.end());
