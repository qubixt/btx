...
static void AssembleBlock(benchmark::Bench& bench)
{
    ...
    // The benchmark still spends simple OP_TRUE P2WSH coinbases for speed,
    // but outputs must be standard under BTX P2MR-only relay policy.
    ...
    for (size_t b{0}; b < NUM_BLOCKS; ++b) {
        ...
        tx.vout.emplace_back(1337, p2mr_script);
