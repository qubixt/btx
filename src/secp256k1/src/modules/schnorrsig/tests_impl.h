...
/* Helper function for schnorrsig_bip_vectors
 * Checks that both verify and verify_batch (TO-DO) return the same value as expected. */
 ...
 * verify_batch (TO-DO). Then flips some bits and checks that verification now
 * fails. */
static void test_schnorrsig_sign_verify(void) {
...

    {
         ...
         * verify and verify_batch (TO-DO) fail */
