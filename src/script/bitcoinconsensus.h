...
enum
{
    ...
    bitcoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKTEMPLATEVERIFY = (1U << 21), // enable CHECKTEMPLATEVERIFY
    bitcoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKSIGFROMSTACK   = (1U << 22), // enable CHECKSIGFROMSTACK
    bitcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL                 = bitcoinconsensus_SCRIPT_FLAGS_VERIFY_P2SH | bitcoinconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |
                                                               ...
                                                               bitcoinconsensus_SCRIPT_FLAGS_VERIFY_TAPROOT | bitcoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKTEMPLATEVERIFY |
                                                               bitcoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKSIGFROMSTACK
};
