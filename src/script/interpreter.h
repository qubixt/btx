...
struct PrecomputedTransactionData
{
    ...
    // CTV precomputed data.
    uint256 m_ctv_scriptsigs_hash;
    uint256 m_ctv_shielded_bundle_hash;
    bool m_ctv_has_scriptsigs = false;
    bool m_ctv_has_shielded_bundle = false;
...
enum class SigVersion
{
    ...
    P2MR = 4,        //!< Witness v2 with 32-byte Merkle root, P2MR script path spending
};
...
extern const HashWriter HASHER_CSFS;       //!< Hasher with tag "CSFS/btx" pre-fed to it.
