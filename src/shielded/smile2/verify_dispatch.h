 ...
 *
 * Note: this validates the in-tree reset-chain `DIRECT_SMILE` launch
 * verifier. Remaining follow-on work is limited to registry-redesign
 * activation and related state-management concerns, not completion of the
 * base Figure 17 launch relation.
 *
