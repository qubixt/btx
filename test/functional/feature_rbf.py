...
class ReplaceByFeeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if not probe.get("allowed", False) and probe.get("reject-reason") == "scriptpubkey":
            self.log.info("BTX policy mode: MiniWallet default script type is non-standard; running RBF policy checks.")
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.hash}; new feerate 0.00300000 BTX/kvB <= old feerate 0.00300000 BTX/kvB"
