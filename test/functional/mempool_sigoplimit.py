...
class BytesPerSigOpTest(BitcoinTestFramework):
    ...
    def test_legacy_sigops_stdness(self):
        ...
        # Restart with the test settings and a fresh mempool. Earlier package
        # tests intentionally craft non-standard relay edge-cases that should
        # not leak into this standardness-focused branch.
        self.restart_node(0, extra_args=[f'-maxtxlegacysigops={MAX_STD_LEGACY_SIGOPS}', '-persistmempool=0'])
