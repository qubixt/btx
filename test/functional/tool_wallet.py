...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def test_tool_wallet_info(self):
        ...
        #
        # NOTE: Wallet tool info should work with wallet file permissions set to
        ...
        #
        # NOTE: Wallet tool info should not write to the wallet file.
        # The following lines should be uncommented and the tests still succeed:
        #
    ...
    def test_salvage(self):
        # NOTE: Check salvage actually salvages and doesn't break things. https://github.com/bitcoin/bitcoin/issues/7463
