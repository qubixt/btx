...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def _supports_wallet_address_type(self, address_type):
        try:
            ...
            if "unsupported address type" in lowered or "only address type 'p2mr'" in lowered:
                return False
            raise
    ...
    def test_option_feerate(self):
        self.log.info("Test fundrawtxn with explicit fee rates (fee_rate sat/vB and feeRate BTX/kvB)")
        node = self.nodes[3]
    ...
    def test_option_subtract_fee_from_outputs(self):
        ...
        # Test subtract fee from outputs with feeRate (BTX/kvB)
