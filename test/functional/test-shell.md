...
20NN-NN-NNTNN:NN:NN.NNNNNNN TestFramework (INFO): Initializing test directory /path/to/bitcoin_func_test_PLACEHOLDER
```
...
20NN-NN-NNTNN:NN:NN.NNNNNNN TestFramework.node0 (INFO): Successfully mined regtest chain!
```
...
```
>>> test.shutdown()
20NN-NN-NNTNN:NN:NN.NNNNNNN TestFramework (INFO): Stopping nodes
20NN-NN-NNTNN:NN:NN.NNNNNNN TestFramework (INFO): Cleaning up /path/to/bitcoin_func_test_PLACEHOLDER on exit
20NN-NN-NNTNN:NN:NN.NNNNNNN TestFramework (INFO): Tests successful
```
...
>>> test.shutdown()
20NN-NN-NNTNN:NN:NN.NNNNNNN TestFramework (INFO): Stopping nodes
20NN-NN-NNTNN:NN:NN.NNNNNNN TestFramework (INFO): Not cleaning up dir /path/to/bitcoin_func_test_PLACEHOLDER on exit
20NN-NN-NNTNN:NN:NN.NNNNNNN TestFramework (INFO): Tests successful
```
...
* `/path/to/bitcoin/build/test/functional/combine_logs.py
  '/path/to/bitcoin_func_test_PLACEHOLDER'`
