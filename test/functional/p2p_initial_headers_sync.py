...
class HeadersSyncTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [["-matmulvalidation=economic", "-disablewallet=1"]]
    ...
    def run_test(self):
        ...
        self.log.info("Restarting node in MatMul consensus mode")
        ...
        consensus_peer.wait_for_getheaders(block_hash=best_block_hash)
        consensus_peer.send_message(msg_headers())
