...
ADDRESS_BCRT1_UNSPENDABLE = 'btxrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqdmjdx9'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(btxrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqdmjdx9)#7lctfhnl'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'btxrt1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsqvynv9r'
...
def create_deterministic_address_bcrt1_p2tr_op_true(explicit_internal_key=None):
    ...
    if explicit_internal_key is None:
        assert_equal(address, 'btxrt1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqs9tn552')
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("bc" if main else "btxrt", version, program)
...
def bech32_to_bytes(address):
    ...
    if hrp not in ['bc', 'btx', 'tbtx', 'tbtx4', 'btxrt', 'tb', 'bcrt']:
        return (None, None)
...
def address_to_scriptpubkey(address):
    ...
    # NOTE: also support other address formats
    else:
        assert False
