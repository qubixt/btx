...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def set_binary_paths(self):
        ...
        for binary, (attribute_name, env_variable_names, legacy_binary) in binaries.items():
            ...
            configured = None
            for env_name in env_variable_names:
            ...
            if configured is None:
                configured = default_filename if os.path.exists(default_filename) else legacy_filename

            setattr(self.options, attribute_name, configured)
