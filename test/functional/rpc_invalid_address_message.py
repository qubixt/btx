...
BECH32_VALID = 'btxrt1qtmp74ayg7p24uslctssvjm06q5phz4yrvvuwqd'
BECH32_VALID_UNKNOWN_WITNESS = 'btxrt1p424qht7nmw'
BECH32_VALID_CAPITALS = 'BTXRT1QPLMTZKC2XHARPPZDLNPAQL78RSHJ68U3MNE3DZ'
BECH32_VALID_MULTISIG = 'btxrt1qdg3myrgvzw7ml9q0ejxhlkyxm7vl9r56yzkfgvzclrf4hkpx9yfqtu7g58'

BECH32_INVALID_BECH32 = 'btxrt1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vq3xkr60'
BECH32_INVALID_BECH32M = 'btxrt1qw508d6qejxtdg4y5r3zarvary0c5xw7kmyl93v'
BECH32_INVALID_VERSION = 'btxrt130xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqcwud2p'
BECH32_INVALID_SIZE = 'btxrt1sqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq5mxt9z'
BECH32_INVALID_V0_SIZE = 'btxrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzmmyy'
BECH32_INVALID_PREFIX = 'bc1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7k7grplx'
BECH32_TOO_LONG = 'btxrt1qtmp74ayg7p24uslctssvjm06q5phz4yrvvuwqdqtmp74ayg7p24uslctssvjm06q5phz4yrvvuwqdqtmp74ayg7p24uslctssvjm06q5phz4yrvvuwqd'
BECH32_ONE_ERROR = 'btxrt1qtmp74ayg7p24uslctssvjm06q5phz4yrvvuxqd'
BECH32_ONE_ERROR_CAPITALS = 'BTXRT1QPLMTZKC2XHARPPZDLNPAQL78RSHJ68U3MNEXDZ'
BECH32_TWO_ERRORS = 'btxrt1qtmp74ayg7p24uslctssvjm06q5phz4yrvxuxqd'
BECH32_NO_SEPARATOR = 'btxrtqtmp74ayg7p24uslctssvjm06q5phz4yrvvuwqd'
BECH32_INVALID_CHAR = 'btxrt1qtmpo4ayg7p24uslctssvjm06q5phz4yrvvuwqd'
BECH32_MULTISIG_TWO_ERRORS = 'btxrt1qdg3myxgvzw7ml9qxejxhlkyxm7vl9r56yzkfgvzclrf4hkpx9yfqtu7g58'
BECH32_WRONG_VERSION = 'btxrt1ptmp74ayg7p24uslctssvjm06q5phz4yrjwmfgy'
...
class InvalidAddressErrorMessageTest(BitcoinTestFramework):
    ...
    def check_invalid(self, addr, error_str, error_locations=None):
        ...
        if addr.lower().startswith('btxrt') or addr.lower().startswith('bc'):
    ...
    def test_validateaddress(self):
        ...
        self.check_invalid(BECH32_ONE_ERROR, 'Invalid Bech32 checksum')
        self.check_invalid(BECH32_TWO_ERRORS, 'Invalid Bech32 checksum')
        self.check_invalid(BECH32_ONE_ERROR_CAPITALS, 'Invalid Bech32 checksum')
        ...
        self.check_invalid(BECH32_MULTISIG_TWO_ERRORS, 'Invalid Bech32 checksum')
        self.check_invalid(BECH32_WRONG_VERSION, 'Invalid Bech32 checksum')
