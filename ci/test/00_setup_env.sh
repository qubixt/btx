...
# Prefer UTF-8 locale where available; macOS host runners may not ship C.UTF-8.
...
# Whether test_runner.py should suppress progress output.
export TEST_RUNNER_QUIET=${TEST_RUNNER_QUIET:-true}
