...
#
# Generate BTX fixed-seed candidates from DNS crawler exports.
#
...
# BTX mainnet launched in 2026; keep the default floor low enough for early
# network bootstrap and raise it as chain height matures.
MIN_BLOCKS = 1000
...
def main():
    ...
    # Filter out hosts with multiple BTX ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple BTX ports', file=sys.stderr)
