...
bech32_templates = [
  ...
  ('tbtx',  0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tbtx',  0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tbtx',  1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tbtx',  3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tbtx4', 0, 20, (False, 'testnet4', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tbtx4', 0, 32, (False, 'testnet4', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tbtx4', 1, 32, (False, 'testnet4', None, True), Encoding.BECH32M, p2tr_prefix),
  ('tbtx4', 3, 32, (False, 'testnet4', None, True), Encoding.BECH32M, (OP_3, 32)),
  ('btxrt', 0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('btxrt', 0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('btxrt', 1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('btxrt',16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tbtx',  17, 32, Encoding.BECH32M, False, False, False),
  ('btxrt',  3,  1, Encoding.BECH32M, False, False, False),
  ('bc',    15, 41, Encoding.BECH32M, False, False, False),
  ('tbtx',   0, 16, Encoding.BECH32,  False, False, False),
  ('btxrt',  0, 32, Encoding.BECH32,  True,  False, False),
  ('bc',     0, 16, Encoding.BECH32,  True,  False, False),
  ('tbtx',   0, 32, Encoding.BECH32,  False, True,  False),
  ('btxrt',  0, 20, Encoding.BECH32,  False, False, True),
  ('bc',     0, 20, Encoding.BECH32M, False, False, False),
  ('tbtx',   0, 32, Encoding.BECH32M, False, False, False),
  ('btxrt',  0, 20, Encoding.BECH32M, False, False, False),
  ('bc',     1, 32, Encoding.BECH32,  False, False, False),
  ('tbtx4',  2, 16, Encoding.BECH32,  False, False, False),
  ('btxrt', 16, 20, Encoding.BECH32,  False, False, False),
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['bc', 'btx', 'tbtx', 'tbtx4', 'btxrt']:
